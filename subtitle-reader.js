...
class SubtitleReader {
  ...
  processText(text, mdHtml) {
    // 清理文本
    const cleanedText = text.replace(/[\u{1F300}-\u{1F5FF}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F700}-\u{1F77F}\u{1F780}-\u{1F7FF}\u{1F800}-\u{1F8FF}\u{1F900}-\u{1F9FF}\u{1FA00}-\u{1FA6F}\u{1FA70}-\u{1FAFF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}]/gu, '')
    ...
    const cleanedLines = mdLines.map(line => {
      return line.replace(/[\u{1F300}-\u{1F5FF}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F700}-\u{1F77F}\u{1F780}-\u{1F7FF}\u{1F800}-\u{1F8FF}\u{1F900}-\u{1F9FF}\u{1FA00}-\u{1FA6F}\u{1FA70}-\u{1FAFF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}]/gu, '')
                .replace(/[^\p{L}\p{N}\p{P}\p{Z}]/gu, '')
                .replace(/\s+/g, ' ')
                .trim();
    }).filter(line => line);
    ...
    for (let i = 0; i < mdLines.length; i++) {
      ...
      if (linePos !== -1) {
        ...
        for (let j = 0; j < units.length; j++) {
          ...
          // 清理单位文本
          const cleanedUnitText = unit.text.replace(/[\u{1F300}-\u{1F5FF}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F700}-\u{1F77F}\u{1F780}-\u{1F7FF}\u{1F800}-\u{1F8FF}\u{1F900}-\u{1F9FF}\u{1FA00}-\u{1FA6F}\u{1FA70}-\u{1FAFF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}]/gu, '')
                                      .replace(/[^\p{L}\p{N}\p{P}\p{Z}]/gu, '')
                                      .replace(/\s+/g, ' ')
                                      .trim();
